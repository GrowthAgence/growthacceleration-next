...
const lines = [
  { type: "command", text: "$ hermes init mon-entreprise" },
  { type: "success", text: "✔ Memoire initialisee — profils crees" },
  { type: "command", text: "$ hermes skill add veille-contenu" },
  { type: "success", text: "✔ 16 sources configurees (cron 7h00)" },
  { type: "command", text: '$ hermes cron add "briefing-9h" --daily' },
  { type: "output", text: "[Agent] Scraping 16 sources..." },
  { type: "output", text: "[Agent] Top 5 selectionne, brief genere..." },
  { type: "success", text: "✔ Post LinkedIn redige — en attente de validation" },
  { type: "command", text: '$ hermes delegate "prospection" --agent claude-code' },
  { type: "success", text: "✔ 12 leads qualifies, emails personnalises prets" },
];
  ...
  return (
    <div className="bg-[#1E1E1E] rounded-lg border border-[#E07A5F]/20 overflow-hidden shadow-2xl">
      <div className="flex items-center gap-2 px-4 py-3 bg-[#2D2A2E] border-b border-[#FAFAFA]/10">
        ...
        <span className="ml-2 text-[#A9A9A9] text-xs font-mono">hermes — zsh</span>
      </div>
